...
void makeGraphics(){
    ...
    drawTimeTrajectory(oscillatorE.getTimeCoords(), oscillatorE.getXCoords(), "График фазовой траектории (метод Эйлера)", "images/graphics/EulerTime.jpeg");
    ...
    drawTimeTrajectory(oscillatorM.getTimeCoords(), oscillatorM.getXCoords(), "График фазовой траектории (метод средней точки)", "images/graphics/MidpointTime.jpeg");
    ...
    drawTimeTrajectory(oscillatorRK4.getTimeCoords(), oscillatorRK4.getXCoords(), "График фазовой траектории (метод рунге-кутты 4-го порядка)", "images/graphics/RK4Time.jpeg");
    ...
    drawTimeTrajectory(oscillatorImpM.getTimeCoords(), oscillatorImpM.getXCoords(), "График фазовой траектории (неявный метод средней точки)", "images/graphics/ImpMidTime.jpeg");
    ...
    drawTimeTrajectory(oscillatorImpTr.getTimeCoords(), oscillatorImpTr.getXCoords(), "График фазовой траектории (неявный метод трапеций)", "images/graphics/ImpTrTime.jpeg");
    ...
    drawTimeTrajectory(oscillatorABM2.getTimeCoords(), oscillatorABM2.getXCoords(), "График фазовой траектории (неявный метод Адамса-Башфорта-Мултона 2-го порядка)", "images/graphics/ABM2Time.jpeg");
    ...
    drawTimeTrajectory(oscillatorABM4.getTimeCoords(), oscillatorABM4.getXCoords(), "График фазовой траектории (неявный метод Адамса-Башфорта-Мултона 4-го порядка)", "images/graphics/ABM4Time.jpeg");
    ...
    drawTimeTrajectory(oscillatorEmHe.getTimeCoords(), oscillatorEmHe.getXCoords(), "График фазовой траектории (вложенный метод Хойна Эйлера 2(1))", "images/graphics/EmHeunEulerTime.jpeg");
...
void makeEllipses(){
    ...
    drawTimeTrajectory(oscillatorE.getTimeCoords(), oscillatorE.getXCoords(), "График фазовой траектории (метод Эйлера)", "images/ellipse/EulerTime.jpeg");
    ...
    drawTimeTrajectory(oscillatorM.getTimeCoords(), oscillatorM.getXCoords(), "График фазовой траектории (метод средней точки)", "images/ellipse/MidpointTime.jpeg");
    ...
    drawTimeTrajectory(oscillatorRK4.getTimeCoords(), oscillatorRK4.getXCoords(), "График фазовой траектории (метод рунге-кутты 4-го порядка)", "images/ellipse/RK4Time.jpeg");
    ...
    drawTimeTrajectory(oscillatorImpM.getTimeCoords(), oscillatorImpM.getXCoords(), "График фазовой траектории (неявный метод средней точки)", "images/ellipse/ImpMidTime.jpeg");
    ...
    drawTimeTrajectory(oscillatorImpTr.getTimeCoords(), oscillatorImpTr.getXCoords(), "График фазовой траектории (неявный метод трапеций)", "images/ellipse/ImpTrTime.jpeg");
    ...
    drawTimeTrajectory(oscillatorABM2.getTimeCoords(), oscillatorABM2.getXCoords(), "График фазовой траектории (неявный метод Адамса-Башфорта-Мултона 2-го порядка)", "images/ellipse/ABM2Time.jpeg");
    ...
    drawTimeTrajectory(oscillatorABM4.getTimeCoords(), oscillatorABM4.getXCoords(), "График фазовой траектории (неявный метод Адамса-Башфорта-Мултона 4-го порядка)", "images/ellipse/ABM4Time.jpeg");
    ...
    drawTimeTrajectory(oscillatorEmHe.getTimeCoords(), oscillatorEmHe.getXCoords(), "График фазовой траектории (вложенный метод Хойна Эйлера 2(1))", "images/ellipse/EmHeunEulerTime.jpeg");
}
